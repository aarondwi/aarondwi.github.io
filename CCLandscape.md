...
6. [Silo](http://people.csail.mit.edu/stephentu/papers/silo.pdf) works both memory/dist, but those on distributed setting are using HLC/TrueTime/TSO. Variant used in most newsql. [Foedus](http://www.hpl.hp.com/techreports/2015/HPL-2015-37.pdf) is a Silo variant which also utilizes NVM, to manage durability and cold data, but with same CC algorithm
